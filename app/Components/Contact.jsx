...
const Contact = () => {
  return (
    <section className="relative isolate bg-white font-montserrat" id="contact">
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              <div className="flex gap-x-4">
                ...
                <dd>Air University, E-9/4, Islamabad</dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
            ...
            <Image src={contactlogo} alt={"contact-logo"} className="h-45 w-45" />
            </dl>
          </div>
        </div>
        <form
        ...
        >
          ...
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-md bg-[#195294] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#6dd5ed] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Send message
              </button>
            </div>
